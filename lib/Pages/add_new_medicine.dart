...
class _AddNewMedicineState extends State<AddNewMedicine> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() => UserRepo.instance.addMedicineLoader.value ? const Center(
  ...
  Future<void> medicineDataStore() async {
    try {
      ...
      print('$medName, $medContent, $medmg, $selectedMedicineType');
      ...
      medicineContentController.clear();
      medicineTypeController.clear();
      medicineMgController.clear();
      }
    } catch (e) {
